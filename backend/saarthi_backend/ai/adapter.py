...
from src.utils.llm import async_openai, chat_model_name  # noqa: E402
...
_ARTIFACT_PATTERNS = [
    ...
    # Keep [1][2] markers — they are student-facing.
    # "[Source: ...]" labels
...
async def run_chat_stream(
    ...
    try:
        ...
        meta["plan"] = final_state.get("plan") or []
        meta["critic_ok"] = final_state.get("critic_ok")
        meta["critic_notes"] = final_state.get("critic_notes") or ""
